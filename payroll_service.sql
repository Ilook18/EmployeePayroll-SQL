...
(name,basic_pay,start,gender,phone_nmber,department,deductions,taxable_pay,tax,net_pay)values
('Terisa',300000,'2021-12-12','F','7905142218','Marketing',3000,25000,2000,2500000);
